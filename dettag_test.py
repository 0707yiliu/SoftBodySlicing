...
config.enable_stream(rs.stream.color, 1920, 1080, rs.format.bgr8, 30)   #配置color流
...
def det_apriltag():
    ...
    FHD_fx = 1372.0147705078125
    FHD_fy = 1369.2152099609375
    FHD_cx = 967.6801147460938
    FHD_cy = 558.4169311523438
    ...
    while True:
        ...
        for tag in tags:
            ...
            z = -rootTobj[2, 3] / 100
            print(x, y, z)
            # -0.29433624344847237 -0.2579604403801273 -0.0032484096791290085
